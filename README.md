...
Value Types
The value type category comprises most of the built-in types like all numeric types, Boolean, Char and custom structs and also Enum types.
The content of a value type in memory is totally a value. For example, the int is 32 bits data in memory. Also, a custom struct would be a value type.
